...
class RocketBotRoyale:
    ...
    def authenticate(self: Self, timeout: int | None = None) -> AuthenticateResponse:
    ...
    def account(self: Self, timeout: int | None = None) -> AccountResponse:
    ...
    def collect_timed_bonus(self: Self, timeout: int | None = None) -> bool:
        """Collect timed bonus.
    ...
    def send_friend_request(self: Self, friend_code: str, timeout: int | None = None) -> bool:
    ...
    def buy_crate(self: Self, *, elite: bool = False, timeout: int | None = None) -> LootBoxResponses:
        """Purchase a crate.
    ...
    def friend_code_to_id(self: Self, friend_code: str, timeout: int | None = None) -> str:
    ...
    @staticmethod
    def signup(email: str, password: str, username: str, timeout: int | None = None) -> bool:
        """Sign up a new user.
